...
resource "aws_s3_bucket" "frontend" {
  bucket = "task-management-frontend-${data.aws_caller_identity.current.account_id}"
...
resource "aws_cloudfront_origin_access_control" "frontend" {
  name                              = "task-management-frontend-oac"
  description                       = "OAC for task management frontend"
